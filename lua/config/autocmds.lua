...
-- `nvim` with no file: open the file picker instead of an empty buffer
vim.api.nvim_create_autocmd("VimEnter", {
    ...
    callback = function()
        ...
        if vim.fn.argc(-1) > 0 or vim.api.nvim_buf_get_name(0) ~= "" or not empty then
            return -- opened with files, or with stdin
        end
        vim.schedule(function()
