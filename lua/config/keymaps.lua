-- Loaded on VeryLazy (see init.lua). Util.safe_keymap_set skips keys that a plugin spec
-- already owns (lazy `keys`), use plain `vim.keymap.set` for your own maps (see the end of this file).
...
-- half page jumps keep the cursor centered (D / U)
vim.keymap.set("n", "<S-d>", "<C-d>zz")
vim.keymap.set("n", "<S-u>", "<C-u>zz")
-- <C-d> deletes to end of line (the D that the line above overrode)
vim.keymap.set("n", "<C-d>", "<S-d>")

-- jump to start / end of line (replaces the <C-h>/<C-l> window moves above)
vim.keymap.set("n", "<C-h>", "^")
vim.keymap.set("n", "<C-l>", "$")

-- show all functions/methods in the file
